...
@Component      //this is a component, injecting into IoC container.

public class Logininterceptor implements HandlerInterceptor {       //how to intercept token then validate it.
